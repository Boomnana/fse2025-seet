...
# 点击【趣测】进入我的运势页面
fun_test_button = driver.find_element(AppiumBy.CLASS_NAME, 'android.view.ViewGroup')
fun_test_button.click()
time.sleep(5)

# 检查是否提供用户当日的综合运势评分和解读
if driver.find_element(AppiumBy.CLASS_NAME, 'android.view.View'):
